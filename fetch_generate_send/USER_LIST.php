...
<!-- // -----------------logged and logout session -->
    <div class="container-fluid">
      ...
      <button id="sendAtch" style="border:none; background-color:unset; margin-right:50px; width: 100px; margin-top: 10px;">Send File</button>
    </div>
...
document.getElementById('sendAtch').addEventListener('click', () =>{
	console.log('clicked');
	const molt ='';
    $.ajax({
        type: 'POST',
